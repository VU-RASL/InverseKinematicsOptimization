...
namespace BioIK {
	...
	public class BioIK : MonoBehaviour {
		...
		[SerializeField] public bool NullSpace = true;
		...
		public bool NullspaceEnabled = false;
		...
		private void Initialise() {
			if(Evolution == null) {
				Evolution = new Evolution(new Model(this), PopulationSize, Elites, UseThreading, NullspaceEnabled);
			}
		}
		...
		public void SetNullspace(bool nullspace) {
			NullspaceEnabled = nullspace;
		}

		public bool GetNullspace() {
			return NullspaceEnabled;
		}
