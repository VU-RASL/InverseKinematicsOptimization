...
namespace BioIK {
	...
	public class Evolution {		
		...
		public Evolution(Model model, int populationSize, int elites, bool useThreading, bool NullspaceEnabled) {
			Model = model;
            ...
            for(int i=0; i<Elites; i++) {
                int index = i;
                // Debug.Log(Model.GetCharacter());
                Models[index] = new Model(Model.GetCharacter());
                Optimisers[index] = new BFGS(Dimensionality, x => Models[index].ComputeLoss(x), y => Models[index].ComputeGradient(y, 1e-5), NullspaceEnabled);
            }
		...
		private void Reproduce(Individual offspring, Individual parentA, Individual parentB, Individual prototype) {
            ...
            // Debug.Log("Um... we're computing loss now " + offspring.Fitness.ToString());
		}
    ...
    public partial class BFGS {
        ...
        public BFGS(int dimensionality, System.Func<double[], double> function, System.Func<double[], double[]> gradient, bool NullspaceEnabled) {
            ...
            LowerBounds = new double[Dimensionality];
            Solution = new double[Dimensionality];
            NullspaceOptimize = NullspaceEnabled;
        ...
        {   
            ...
            var sinTheta3 = System.Math.Sin(theta3);
            var sinTheta5 = System.Math.Sin(theta5);
            var sinTheta1Theta2 = System.Math.Sin(theta1 + theta2);
            var sinTheta3Theta4 = System.Math.Sin(theta3 + theta4);
            var sinTheta6Theta7 = System.Math.Sin(theta6 + theta7);

            var cosTheta3 = System.Math.Cos(theta3);
            var cosTheta5 = System.Math.Cos(theta5);
            var cosTheta1Theta2 = System.Math.Cos(theta1 + theta2);
            var cosTheta3Theta4 = System.Math.Cos(theta3 + theta4);
            var cosTheta6Theta7 = System.Math.Cos(theta6 + theta7);
